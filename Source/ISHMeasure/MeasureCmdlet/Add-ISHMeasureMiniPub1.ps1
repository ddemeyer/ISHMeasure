function Add-ISHMeasureMiniPub1
{
<#
.SYNOPSIS
    Adds small publication consisting out of 5 image, 15 topic, 1 map and 1 pub
...
Process
{
    ...
    { 
        ...
        try {
            $scriptBlock = { 
                Add-ISHMeasureImage -ISHRemotePubResult $script:ishRemotePubResult -Count 5
                Add-ISHMeasureTopic -ISHRemotePubResult $script:ishRemotePubResult -Count 15
